...
<div className="position-relative">
  <div className="profile-circle me-3" onClick={toggleProfileDropdown}>
      ...
      {user ? (
        <>
          <div className="d-flex align-items-center px-3 py-2 border-bottom">
            <div className="profile-circle me-3">{user.username.charAt(0).toUpperCase()}</div>
            <div>
              <div className="fw-semibold">{user.username}</div>
              <small className="opacity-75">Guest</small>
            </div>
          </div>
          <Link className="dropdown-item d-flex align-items-center gap-2 px-3" to="/dashboard/account">
            <i className="bi bi-person" /> My Profile
          </Link>
          <Link className="dropdown-item d-flex align-items-center gap-2 px-3" to="/settings">
            <i className="bi bi-gear" /> Settings
          </Link>
          <Link className="dropdown-item d-flex align-items-center gap-2 px-3 position-relative" to="/billing">
            <i className="bi bi-credit-card" /> Billing
            <span className="badge bg-danger rounded-pill ms-auto">4</span>
          </Link>
          <Link className="dropdown-item d-flex align-items-center gap-2 px-3" to="/pricing">
            <i className="bi bi-currency-dollar" /> Pricing
          </Link>
          <Link className="dropdown-item d-flex align-items-center gap-2 px-3" to="/faq">
        ...
        <div className="px-3 py-2">
          <div className="fw-semibold mb-2">You are not logged in</div>
          <Link className="btn btn-primary w-100" to="/login" onClick={() => setProfileDropdown(false)}>
            Login
          </Link>
        </div>
      )}
