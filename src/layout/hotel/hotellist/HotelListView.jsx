  ...
  const renderFilters = () => (
    <div>
      ...
      >
        ...
        <div className="collapse d-md-block mt-2" id="facilitiesDropdown">
          {facilityOptions.length > 0 ? (
            ...
            <p className="small text-muted">No facilities available</p>
          )}
        </div>
      </div> */}
              ...
              <>
                ...
                {totalPages > 1 && (
                  <nav aria-label="Page navigation example">
                    <ul className="pagination justify-content-end bg-dark p-2 rounded">
                      <li
                        className={`page-item ${
